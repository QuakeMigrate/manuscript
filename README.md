...
## Notes
These figures were prepared using macOS 15.5, Ubuntu 22.04, and Rocky Linux 9.6. A limited number were produced using Affinity Designer, a licensed piece of software for graphic design. `.afdesign` files are provided.
